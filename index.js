...
function makeLogin(jar, email, password, loginOptions, callback, prCallback) {
  return function (res) {
    ...
    return utils
      .post("https://m.facebook.com/login/?next&ref=dbl&fl&refid=8", jar, form, loginOptions)
      ...
      .then(function (res) {
        ...
        if (headers.location.indexOf('https://m.facebook.com/checkpoint/') > -1) {
          log.info("login", "You have login approvals turned on.");
          var nextURL = 'https://m.facebook.com/checkpoint/?next=https%3A%2F%2Fwww.facebook.com%2Fhome.php';
                ...
                throw {
                  ...
                  continue: function submit2FA(code) {
                    ...
                    if (typeof code == "string") {
                      ...
                      utils
                        .post("https://m.facebook.com/checkpoint/?next=https%3A%2F%2Fwww.facebook.com%2Fhome.php", jar, form, loginOptions, null, { "Referer": "https://www.facebook.com/checkpoint/?next" })
                        .then(utils.saveCookies(jar))
                        .then(res => {
                          try {
